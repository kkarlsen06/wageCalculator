...
app.post('/chat', authenticateUser, async (req, res) => {
  ...
  // Inject user name context for GPT
  const systemContextHint = {
    role: 'system',
    content: `Brukerens navn er ${userName}, så du kan bruke navnet i svarene dine for å gjøre dem mer personlige.`
  };
  const messagesWithContext = [systemContextHint, ...messages];
