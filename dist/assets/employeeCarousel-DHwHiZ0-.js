const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/employeeActionsMenu-CuTYrhGM.js","assets/kalkulator-C3sRTWD8.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/runtime-config-CwEj8XBa.js","assets/kalkulator-BYzzdff5.css","assets/employeeModal-B0VnrISH.js"])))=>i.map(i=>d[i]);
import{_ as r}from"./kalkulator-C3sRTWD8.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./runtime-config-CwEj8XBa.js";class u{constructor(e,t){this.container=e,this.app=t,this.isInitialized=!1,this.touchStartX=0,this.touchStartY=0,this.isDragging=!1,this.scrollStartX=0,this.longPressTimer=null,this.longPressThreshold=500,this.renderCache=new Map,this.lastRenderKey="",this.virtualizationThreshold=30,this.visibleRange={start:0,end:20},this.itemWidth=80,this.isVirtualized=!1,this.isMobile=window.innerWidth<=768,this.touchThreshold=10,this.init()}init(){this.isInitialized||(this.createCarouselStructure(),this.attachEventListeners(),this.isInitialized=!0,this.render())}createCarouselStructure(){this.container.innerHTML=`
