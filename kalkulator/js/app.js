  ...
  if (snapContainer && floatingBar && shiftSection) {
    ...
    function checkFloatingBarVisibility() {
      ...
      if (shouldBeVisible && !isVisible) {
        ...
        floatingBar.style.animation = isMobile ? 'fadeInUpMobile 0.3s ease-out forwards' : 'fadeInUp 0.3s ease-out forwards';
        floatingBar.style.opacity = '1';
      } else if (!shouldBeVisible && isVisible) {
        // Hide with fade out animation
        isVisible = false;
        clearTimeout(animationTimeout);
        floatingBar.style.animation = isMobile ? 'fadeOutDownMobile 0.3s ease-out forwards' : 'fadeOutDown 0.3s ease-out forwards';
        floatingBar.style.opacity = '0';
