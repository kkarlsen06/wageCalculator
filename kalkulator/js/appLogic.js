...
export const app = {
    ...
    renderStatCards(stats) {
        ...
        let maxCards = Math.max(0, Math.floor((available + gap) / spacePerCard));
        ...
        while (container.getBoundingClientRect().bottom > window.innerHeight && container.lastElementChild) {
