export const app = {
    ...
    showBreakdown(type) {
        ...
        modal.id = 'breakdownModalDynamic';
        modal.className = 'modal show';
        modal.onclick = (e) => { if (e.target === modal) this.closeBreakdown(); };

        // Modal content element
        const content = document.createElement('div');
        content.className = 'modal-content breakdown-modal-custom';
        ...
        // Add modal to body and activate
    ...
    showShiftDetails(shiftId) {
        ...
        // Create modal container
        const modal = document.createElement('div');
        modal.id = 'shiftDetailModal';
        modal.className = 'modal show';
        modal.onclick = (e) => { if (e.target === modal) this.closeShiftDetails(); };

        // Create shift detail card content
